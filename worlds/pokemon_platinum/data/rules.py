...
class Rules:
    ...
    def fill_rules(self):
        self.common_rules.update({
            "national_dex": (lambda state : state.has("Upgradable Pokedex", self.player, 3)),
            "dowsingmachine_if_opt": (lambda state : state.has_all(["Poketch", "DOWSING MACHINE"], self.player)) if self.opts.dowsing_machine_logic.value != 0 else always_true,
            ...
            "poketch_req": (lambda state : state.has_all(["Coupon 1", "Coupon 3", "Coupon 2", "Parcel"], self.player)),
        })
        self.exit_rules = {
            ...
            ("wayward_cave_1f", "virt_wayward_cave_1f_red_shard"): (self.common_rules["rock_smash"]),
            ("mt_coronet_1f_south", "mt_coronet_2f_right"): (lambda state : self.common_rules["surf"](state) and self.common_rules["rock_climb"](state)),
            ...
            ("route_226_east", "route_226_mid"): (lambda state : self.common_rules["surf"](state) and self.common_rules["rock_climb"](state)),
        ...
        self.location_rules = {
            ...
            "Sandgem Town Pokemon Research Lab - National Pokedex from Prof Oak": (self.common_rules["regional_mons"](self.opts.regional_dex_goal.value)),
            "Sandgem Town Pokemon Research Lab - Poke Radar from Rowan": (self.common_rules["regional_mons"](self.opts.regional_dex_goal.value)),
            ...
            "Route 208 - Hidden Item Above Rock Climb Slope": (lambda state : self.common_rules["rock_smash"](state) and self.common_rules["rock_climb"](state)),
            "Route 208 - Item Above Waterfall": (lambda state : self.common_rules["surf"](state) and self.common_rules["waterfall"](state)),
            ...
            "Solaceon Town - Pokemon History App from Ruin Maniac": (self.common_rules["regional_mons"](50)),
            ...
            "Route 210 North - Hidden Item up East Waterfall": (lambda state : self.common_rules["surf"](state) and self.common_rules["waterfall"](state)),
            "Route 210 North - Item Under West Bridge": (lambda state : self.common_rules["surf"](state) and self.common_rules["waterfall"](state)),
            ...
            "Route 211 East - Hidden Item Up Rock Climb Slope": (lambda state : self.common_rules["rock_smash"](state) and self.common_rules["rock_climb"](state)),
            "Route 211 East - Item Up Rock Climb Slope": (lambda state : self.common_rules["rock_smash"](state) and self.common_rules["rock_climb"](state)),
            ...
            "Route 212 South - Item Near Scientist Between Cut Trees": (lambda state : state.has("Bicycle", self.player) and self.common_rules["cut"](state)),
            "Route 212 South - Item on Ledge Above Move Tutor": (lambda state : state.has("Bicycle", self.player) and self.common_rules["cut"](state)),
            ...
            "Mt. Coronet Tunnel to 1F - Hidden Item Behind Breakable Rock on Left": (lambda state : self.common_rules["rock_smash"](state) and self.common_rules["rock_climb"](state)),
            ...
            "Mt. Coronet B1F - Hidden Item in SW White Rock": (self.common_rules["rock_smash"]),
            "Mt. Coronet B1F - Item in Middle of Lake": (self.common_rules["surf"]),
            "Mt. Coronet B1F - Item in Northeast Corner of Lake": (lambda state : self.common_rules["rock_smash"](state) or self.common_rules["surf"](state)),
            ...
            "Mt. Coronet Outside 1 - Hidden Item on Rock in Grass Above Upper Rock Climb Slope": (self.common_rules["rock_smash"]),
            ...
            "Mt. Coronet 4F Room Above Waterfall - Item 1": (lambda state : self.common_rules["surf"](state) and self.common_rules["waterfall"](state)),
            "Mt. Coronet 4F Room Above Waterfall - Item 2": (lambda state : self.common_rules["surf"](state) and self.common_rules["waterfall"](state)),
            "Mt. Coronet 4F Room Above Waterfall - Hidden Item in Rock": (lambda state : self.common_rules["surf"](state) and self.common_rules["waterfall"](state)),
            "Mt. Coronet 2F - Gift from Looker": (lambda state : state.has("event_galactic_hq_defeat_cyrus", self.player)),
            "Mt. Coronet 2F - Hidden Item on Rock Down East Staircase After Mural": (lambda state : state.has("event_galactic_hq_defeat_cyrus", self.player)),
            ...
            "Poketch Company - Memo Pad App": (lambda state : state.has_all(["Coupon 1", "Coupon 3", "Coupon 2", "Parcel"], self.player) and self.common_rules["badges"](1)(state)),
            "Poketch Company - Marking Map App": (lambda state : state.has_all(["Coupon 1", "Coupon 3", "Coupon 2", "Parcel"], self.player) and self.common_rules["badges"](3)(state)),
            "Poketch Company - Link Searcher App": (lambda state : state.has_all(["Coupon 1", "Coupon 3", "Coupon 2", "Parcel"], self.player) and self.common_rules["badges"](5)(state)),
            "Poketch Company - Move Tester App": (lambda state : state.has_all(["Coupon 1", "Coupon 3", "Coupon 2", "Parcel"], self.player) and self.common_rules["badges"](7)(state)),
