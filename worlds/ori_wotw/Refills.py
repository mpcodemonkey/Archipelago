...
refills: dict[str, tuple[int, int, int]] = {  # key: region name. Tuple: [health restored, energy restored, refill type]
    ...
    "WestHollow.PastRockPuzzleDoor": (0, 0, 1),
    "WestHollow.PastRockPuzzleDoorEnemyPaths": (0, 0, 1),
    ...
    "GladesTown.KeyMokiHutInside": (0, 0, 0),
    "GladesTown.West": (0, 0, 1),
    "GladesTown.MotayHut": (0, 0, 0),
    "GladesTown.MotayHutInside": (0, 0, 0),
    "GladesTown.UpperWest": (0, 0, 0),
    "GladesTown.InsideThirdHut": (0, 0, 0),
    "GladesTown.AcornMoki": (0, 0, 0),
    "GladesTown.AcornCave": (0, 4, 0),
    "GladesTown.BelowBountyShard": (0, 0, 0),
    "GladesTown.LeftAboveCoals": (0, 0, 0),
    "GladesTown.AboveOpher": (0, 0, 0),
    "GladesTown.StorageHut": (0, 0, 0),
    "GladesTown.PlayfulMoki": (0, 0, 0),
    "GladesTown.LupoHouse": (0, 0, 0),
    "GladesTown.InsideLupoHouse": (0, 0, 0),
    "GladesTown.HoleHut": (0, 0, 0),
    "GladesTown.HoleHutEntrance": (0, 0, 0),
    "GladesTown.InsideHoleHut": (0, 0, 0),
    ...
    "WoodsEntry.FamilyHut": (0, 0, 0),
    "WoodsEntry.FamilyHutInside": (0, 0, 0),
    ...
    "WeepingRidge.WillowEntranceLedge": (0, 0, 1),
    ...
    "WillowsEnd.ShriekArena": (0, 0, 0),
    "WillowsEnd.MiniBossFight": (2, 0, 1),
...
refill_events: list[str] = [
    ...
    "C.WestHollow.PastRockPuzzleDoor",
    "C.WestHollow.PastRockPuzzleDoorEnemyPaths",
    ...
    "C.WeepingRidge.WillowEntranceLedge",
    "C.WillowsEnd.Entry",
    "E.WillowsEnd.Entry",
    ...
    "C.WillowsEnd.Upper",
    "E.WillowsEnd.Upper",
    "C.WillowsEnd.MiniBossFight",
    "H.WillowsEnd.MiniBossFight",
    "C.WillowsEnd.West",
    "E.WillowsEnd.West",
