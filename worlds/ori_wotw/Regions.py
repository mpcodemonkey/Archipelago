...
region_table = [
    ...
    "WestHollow.PastRockPuzzleDoorEnemyPaths",
    ...
    "WoodsEntry.FirstMud",
    "WoodsEntry.FamilyHut",
    "WoodsEntry.FamilyHutInside",
