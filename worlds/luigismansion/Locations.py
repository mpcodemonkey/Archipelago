...
SILVER_PORTRAIT_TABLE: dict[str, LMLocationData] = {
    ...
    "Catch The Twins  - Silver": LMLocationData("Twins' Room", 978, "Portrait", 79, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803cfa87, bit_position=5)]),
    "Catch The Whirlindas - Silver": LMLocationData("Ballroom", 979, "Portrait", 34, [], remote_only=True,
    ...
    "Catch Petunia - Silver": LMLocationData("2F Bathroom", 988, "Portrait", 83, ["Ice Element Medal"],
    ...
    "Catch Van Gore - Silver": LMLocationData("Artist's Studio", 995, "Portrait", 107, [],
...
GOLD_PORTRAIT_TABLE: dict[str, LMLocationData] = {
    ...
    "Catch The Twins - Gold": LMLocationData("Twins' Room", 953, "Portrait", 79, [], remote_only=True, all_true=True,
        update_ram_addr=[LMRamData(0x803cfa87, bit_position=5),
                         LMRamData(0x803cfa87, bit_position=4)]),
    "Catch The Whirlindas - Gold": LMLocationData("Ballroom", 954, "Portrait", 34, [], remote_only=True, all_true=True,
    ...
    "Catch Petunia - Gold": LMLocationData("2F Bathroom", 963, "Portrait", 83, ["Ice Element Medal"], all_true=True,
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa87, bit_position=1),
    ...
    "Catch Van Gore - Gold": LMLocationData("Artist's Studio", 970, "Portrait", 107, [], all_true=True,
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa88, bit_position=5),
